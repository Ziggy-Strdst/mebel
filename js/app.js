    ...
    (() => {
        ...
        if (rangeSlider) {
            ...
            rangeSlider.noUiSlider.on("update", (function(values, handle) {
                ...
                const allItems2 = Array.from(document.querySelectorAll(".item"));
                allItems2.map((function(el) {
                    if (+el.getAttribute("data-price") >= values[0] && +el.getAttribute("data-price") <= values[1]) el.classList.remove("hidden2"); else el.classList.add("hidden2");
                }));
            }));
        ...
        if (burgerBtn) {
            const menuBodyEl = document.querySelector(".mobile__menu");
            ...
            burgerBtn.addEventListener("click", (function(e) {
                ...
                headerBodyEl.classList.toggle("active");
            }));
        }
        ...
        const popUpCallBtn = document.querySelector(".pop-up-call-btn");
        const popUpCallClose = document.querySelector(".pop-up-call-close");
        if (popUpCallBtn) popUpCallBtn.addEventListener("click", (function(e) {
            e.preventDefault();
            popUpCall.classList.add("active");
        }));
        if (popUpCallClose) popUpCallClose.addEventListener("click", (function(e) {
            e.preventDefault();
            popUpCall.classList.remove("active");
        }));
        if (document.querySelectorAll("input[type=checkbox]") || document.querySelectorAll(".item")) {
            const allCheckboxes = document.querySelectorAll("input[type=checkbox]");
            const allItems = Array.from(document.querySelectorAll(".item"));
            const checked = {};
            getChecked("stock");
            getChecked("textile");
            getChecked("mechanism");
            getChecked("style");
            ...
            function setVisibility() {
                allItems.map((function(el) {
                    var stock = checked.stock.length ? _.intersection(Array.from(el.classList), checked.stock).length : true;
                    var textile = checked.textile.length ? _.intersection(Array.from(el.classList), checked.textile).length : true;
                    var mechanism = checked.mechanism.length ? _.intersection(Array.from(el.classList), checked.mechanism).length : true;
                    var style = checked.style.length ? _.intersection(Array.from(el.classList), checked.style).length : true;
                    if (stock && textile && mechanism && style) el.classList.remove("hidden1"); else el.classList.add("hidden1");
                }));
            }
        }
        if (document.querySelector(".catalog__products") || document.getElementById("price-select")) {
            let field = document.querySelector(".catalog__products");
            let fieldItem = Array.from(field.children);
            let priceSelect = document.getElementById("price-select");
            let ar = [];
            let defAr = [];
            for (let i of fieldItem) {
                const x = Number(i.getAttribute("data-price").trim());
                ar.push(x);
                defAr.push(i);
            }
            priceSelect.onchange = sortingValue;
            function sortingValue() {
                if ("default" === this.value) {
                    while (field.firstChild) field.removeChild(field.firstChild);
                    field.append(...defAr);
                }
                if ("lowToHigh" === this.value) sortElem(field, fieldItem, true);
                if ("HighToLow" === this.value) sortElem(field, fieldItem, false);
            }
            function sortElem(field, fieldItem, asc) {
                let sortItem;
                sortItem = fieldItem.sort(((a, b) => {
                    const ax = a.getAttribute("data-price");
                    const bx = b.getAttribute("data-price");
                    if (asc) return ax - bx; else return bx - ax;
                }));
                while (field.firstChild) field.removeChild(field.firstChild);
                field.append(...sortItem);
            }
        }
        const popUpFilter = document.querySelector(".pop-up-filter");
        const popUpFilterBtn = document.querySelector(".filter-btn-mobile");
        const popUpFilterClose = document.querySelector(".pop-up-filter-close");
        if (popUpFilterBtn) popUpFilterBtn.addEventListener("click", (function(e) {
            e.preventDefault();
            popUpFilter.classList.add("active");
        }));
        if (popUpFilterClose) popUpFilterClose.addEventListener("click", (function(e) {
            e.preventDefault();
            popUpFilter.classList.remove("active");
        }));
        const btnDescription = document.querySelector(".tabs-btn-descr");
        const btnCharacteristic = document.querySelector(".tabs-btn-charact");
        const btnRecomendation = document.querySelector(".tabs-btn-recomend");
        const descriptionEl = document.querySelector(".tabs-descr-text");
        const characteristicEl = document.querySelector(".tabs-charact-text");
        const recomendationEl = document.querySelector(".tabs-recomend-text");
        if (btnDescription) btnDescription.addEventListener("click", (function(e) {
            descriptionEl.classList.remove("hidden");
            characteristicEl.classList.add("hidden");
            recomendationEl.classList.add("hidden");
        }));
        if (btnCharacteristic) btnCharacteristic.addEventListener("click", (function(e) {
            characteristicEl.classList.remove("hidden");
            descriptionEl.classList.add("hidden");
            recomendationEl.classList.add("hidden");
        }));
        if (btnRecomendation) btnRecomendation.addEventListener("click", (function(e) {
            recomendationEl.classList.remove("hidden");
            descriptionEl.classList.add("hidden");
            characteristicEl.classList.add("hidden");
        }));
        const deliveryInfoBtn = document.querySelector(".delivery-delivery-btn");
        const deliveryBuyBtn = document.querySelector(".delivery-delivery-buy-btn");
        const deliveryGaranteeBtn = document.querySelector(".delivery-delivery-garantee-btn");
        const deliveryInfoEl = document.querySelector(".delivery-text");
        const deliveryBuyEl = document.querySelector(".buy-text");
        const deliveryGaranteeEl = document.querySelector(".garantee-text");
        if (deliveryInfoBtn) deliveryInfoBtn.addEventListener("click", (function(e) {
            e.preventDefault();
            deliveryInfoEl.classList.remove("hidden");
            deliveryBuyEl.classList.add("hidden");
            deliveryGaranteeEl.classList.add("hidden");
        }));
        if (deliveryBuyBtn) deliveryBuyBtn.addEventListener("click", (function(e) {
            e.preventDefault();
            deliveryBuyEl.classList.remove("hidden");
            deliveryInfoEl.classList.add("hidden");
            deliveryGaranteeEl.classList.add("hidden");
        }));
        if (deliveryGaranteeBtn) deliveryGaranteeBtn.addEventListener("click", (function(e) {
            e.preventDefault();
            deliveryGaranteeEl.classList.remove("hidden");
            deliveryInfoEl.classList.add("hidden");
            deliveryBuyEl.classList.add("hidden");
        }));
        /**
 ...
 */
        (function() {
            ...
            var Un = {
                ...
                function qn(n, t) {
                    var r, e = ff(n), u = !e && of(n), i = !e && !u && af(n), o = !e && !u && !i && _f(n), f = (u = (e = e || u || i || o) ? A(n.length, ni) : [], 
                    u.length);
                ...
                function yt(n, t, r, e) {
                    ...
                    if (!l) return s;
                    r && (t = c(t, k(r))), e ? (i = f, a = false) : 200 <= t.length && (i = O, a = false, 
                    t = new Nn(t));
                    n: for (;++u < l; ) {
                ...
                function Mt(n, t, r, e, u) {
                    if (n === t) t = true; else if (null == n || null == t || !yu(n) && !yu(t)) t = n !== n && t !== t; else n: {
                        var i = ff(n), o = ff(t), f = i ? "[object Array]" : vo(n), c = o ? "[object Array]" : vo(t), a = (f = "[object Arguments]" == f ? "[object Object]" : f, 
                        c = "[object Arguments]" == c ? "[object Object]" : c, "[object Object]" == f);
                        o = "[object Object]" == c;
                        if ((c = f == c) && af(n)) {
                            if (!af(t)) {
                                t = false;
                    ...
                    n !== t && oo(t, (function(i, o) {
                        if (u || (u = new Zn), du(i)) {
                            ...
                            if (l) it(n, o, l); else {
                                ...
                                var s = l === T;
                                if (s) {
                                    var h = ff(a), p = !h && af(a), _ = !h && !p && _f(a);
                                    l = a;
                                    h || p || _ ? ff(c) ? l = c : hu(c) ? l = Ur(c) : p ? (s = false, l = Ir(a, true)) : _ ? (s = false, 
                ...
                function er(n, t, r, e) {
                    ...
                    for (n === t && (t = Ur(t)), r && (f = c(n, k(r))); ++i < o; ) {
                        var a = 0, l = t[i];
                        for (l = r ? r(l) : l; -1 < (a = u(f, l, a, e)); ) f !== n && xi.call(f, a, 1), 
                        xi.call(n, a, 1);
                    }
                    return n;
                }
                ...
                function Kr(t, r, e) {
                    function u() {
                        ...
                        return c = 3 > o && f[0] !== a && f[o - 1] !== a ? [] : L(f, a), o -= c.length, 
                ...
                function Hr(n) {
                    return pe((function(t) {
                        ...
                        return function() {
                            ...
                            var u = 0;
                            for (n = r ? t[u].apply(this, n) : e; ++u < r; ) n = t[u].call(this, n);
                            return n;
                        };
                    }));
                }
                ...
                function ie(n) {
                    ...
                    return function(n, r) {
                        if (n = Su(n), (r = null == r ? 0 : Ci(Eu(r), 292)) && Wi(n)) {
                            ...
                            e = t(e[0] + "e" + (+e[1] + r)), e = (Iu(e) + "e").split("e");
                            return +(e[0] + "e" + (+e[1] - r));
                        }
                        return t(n);
                    };
                ...
                function fe(n, t, r, e, u, i, o, f) {
                    ...
                    var a = e ? e.length : 0;
                    if (a || (t &= -97, e = u = T), o = o === T ? o : Ui(Eu(o), 0), f = f === T ? f : Eu(f), 
                    a -= u ? u.length : 0, 64 & t) {
                        var l = e, s = u;
                        e = u = T;
                    }
                    ...
                    i[3] = e ? Br(e, r, h[4]) : r, i[4] = e ? L(i[3], "__lodash_placeholder__") : h[4]), 
                    ...
                    e = i[3], u = i[4], f = i[9] = i[9] === T ? c ? 0 : n.length : Ui(i[9] - a, 0), 
                    !f && 24 & t && (t &= -25), Ue((h ? co : yo)(t && 1 != t ? 8 == t || 16 == t ? Kr(n, t, f) : 32 != t && 33 != t || u.length ? Jr.apply(T, i) : te(n, t, r, e) : Pr(n, t, r), i), n, t);
                }
                function ce(n, t, r, e) {
                ...
                function Re(n) {
                    var t = ge(n), r = An[t];
                    return "function" == typeof r && t in Un.prototype && (n === r || (t = ho(r), !!t && n === t[0]));
                }
                function ze(n) {
                ...
                function Fe(n) {
                    ...
                    return t.__actions__ = Ur(n.__actions__), t.__index__ = n.__index__, t.__values__ = n.__values__, 
                    t;
                }
                function Ne(n, t, r) {
                ...
                function fu(n, t, r) {
                    ...
                    if ("function" != typeof n) throw new ti("Expected a function");
                    return t = Su(t) || 0, du(r) && (v = !!r.leading, l = (g = "maxWait" in r) ? Ui(Su(r.maxWait) || 0, t) : l, 
                ...
                }(), ai = ei.toString, li = ii.call(Qu), si = $n._, hi = Xu("^" + ii.call(oi).replace(rn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), pi = Pn ? mn.Buffer : T, _i = mn.Symbol, vi = mn.Uint8Array, gi = pi ? pi.g : T, di = B(Qu.getPrototypeOf, Qu), yi = Qu.create, bi = ei.propertyIsEnumerable, xi = ri.splice, ji = _i ? _i.isConcatSpreadable : T, wi = _i ? _i.iterator : T, mi = _i ? _i.toStringTag : T, Ai = function() {
                    try {
                ...
                }, An.prototype = En.prototype, An.prototype.constructor = An, On.prototype = eo(En.prototype), 
                On.prototype.constructor = On, Un.prototype = eo(En.prototype), Un.prototype.constructor = Un, 
                ...
                var go = ui ? _u : Vu, yo = Ce(co), bo = Si || function(n, t) {
                    ...
                    var t = n.length;
                    t = 1 < t ? n[t - 1] : T, t = "function" == typeof t ? (n.pop(), t) : T;
                    return Je(n, t);
                })), To = pe((function(n) {
                    function t(t) {
                        return ht(t, n);
                ...
                var Xo = fr((function(t, r) {
                ...
                }, ff = Ku.isArray, cf = Vn ? k(Vn) : Ct, af = zi || Vu, lf = Kn ? k(Kn) : Dt, sf = Gn ? k(Gn) : Tt, hf = Hn ? k(Hn) : Nt, pf = Jn ? k(Jn) : Pt, _f = Yn ? k(Yn) : Zt, vf = ee(Kt), gf = ee((function(n, t) {
                    return n <= t;
                })), df = $r((function(n, t) {
                    ...
                    for (u && Oe(t[0], t[1], u) && (e = 1); ++r < e; ) {
                        u = t[r];
                        for (var i = Bu(u), o = -1, f = i.length; ++o < f; ) {
                            var c = i[o], a = n[c];
                ...
                An.at = jf, An.before = uu, An.bind = Ho, An.bindAll = Nf, An.bindKey = Jo, An.castArray = function() {
                    ...
                    if (t = (r ? Oe(n, t, r) : t === T) ? 1 : Ui(Eu(t), 0), r = null == n ? 0 : n.length, 
                    !r || 1 > t) return [];
                ...
                An.drop = function(n, t, r) {
                    ...
                    var u = null == n ? 0 : n.length;
                    if (!u) return [];
                    for (r && "number" != typeof r && Oe(n, t, r) && (r = 0, e = u), u = n.length, r = Eu(r), 
                    0 > r && (r = -r > u ? 0 : u + r), e = e === T || e > u ? u : Eu(e), 0 > e && (e += u), 
                    e = r > e ? 0 : ku(e); r < e; ) n[r++] = t;
                    return n;
                ...
                }, An.intersection = Eo, An.intersectionBy = ko, An.intersectionWith = So, An.invert = Af, 
                An.invertBy = Ef, An.invokeMap = Zo, An.iteratee = Fu, An.keyBy = qo, An.keys = Wu, 
                An.keysIn = Bu, An.map = ru, An.mapKeys = function(n, t) {
                    var r = {};
                ...
                An.partialRight = tf, An.partition = Vo, An.pick = Rf, An.pickBy = Lu, An.property = Zu, 
                An.propertyOf = function(n) {
                    ...
                    var e = null == n ? 0 : n.length;
                    return e ? (r && "number" != typeof r && Oe(n, t, r) ? (t = 0, r = e) : (t = null == t ? 0 : Eu(t), 
                    r = r === T ? e : Eu(r)), hr(n, t, r)) : [];
                    ...
                    return e = "function" == typeof e ? e : T, null != n && (n = lr(n, t, kr(r)(kt(n, t)), e)), 
                    n;
                ...
                Nu(An, An), An.add = Qf, An.attempt = Ff, An.camelCase = Bf, An.capitalize = Cu, 
                ...
                }, An.invoke = kf, An.isArguments = of, An.isArray = ff, An.isArrayBuffer = cf, 
                ...
                An.isRegExp = hf, An.isSafeInteger = function(n) {
                    ...
                    a = (i ? a.replace(P, "") : a).replace(Z, "$1").replace(q, "$1;"), a = "function(" + (t || "obj") + "){" + (t ? "" : "obj||(obj={});") + "var __t,__p=''" + (u ? ",__e=_.escape" : "") + (i ? ",__j=Array.prototype.join;function print(){__p+=__j.call(arguments,'')}" : ";") + a + "return __p}", 
                    t = Ff((function() {
                    ...
                    if (du(t)) {
                        ...
                        r = "length" in t ? Eu(t.length) : r, e = "omission" in t ? yr(t.omission) : e;
                    }
                    n = Iu(n);
                    var i = n.length;
                    if (Rn.test(n)) {
                ...
                Nu(An, function() {
                    ...
                    t !== T && (t = Eu(t), r = 0 > t ? r.dropRight(-t) : r.take(t - n)), r);
                    ...
                    u && (An.prototype[t] = function() {
                        ...
                        s && r && "function" == typeof l && 1 != l.length && (c = s = false);
                    ...
                    n.__iteratees__ = Ur(this.__iteratees__), n.__takeCount__ = this.__takeCount__, 
                    n.__views__ = Ur(this.__views__), n;
                    ...
                    return n instanceof Un ? (this.__actions__.length && (n = new Un(this)), n = n.reverse(), 
                    n.__actions__.push({
                        func: Qe,
                        args: [ Ge ],
                        thisArg: T
            ...
            "function" == typeof define && "object" == typeof define.amd && define.amd ? ($n._ = rt, 
            define((function() {
                return rt;
